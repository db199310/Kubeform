...
type SDPAzadfv1Lister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.SDPAzadfv1, err error)
...
// List lists all SDPAzadfv1s in the indexer.
func (s *sDPAzadfv1Lister) List(selector labels.Selector) (ret []*v1alpha1.SDPAzadfv1, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.SDPAzadfv1))
	})
	return ret, err
}
...
type SDPAzadfv1NamespaceLister interface {
	...
	Get(name string) (*v1alpha1.SDPAzadfv1, error)
...
// List lists all SDPAzadfv1s in the indexer for a given namespace.
func (s sDPAzadfv1NamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.SDPAzadfv1, err error) {
...
// Get retrieves the SDPAzadfv1 from the indexer for a given namespace and name.
func (s sDPAzadfv1NamespaceLister) Get(name string) (*v1alpha1.SDPAzadfv1, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("sdpazadfv1"), name)
	}
	return obj.(*v1alpha1.SDPAzadfv1), nil
}
