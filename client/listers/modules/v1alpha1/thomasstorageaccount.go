...
type ThomasStorageAccountLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.ThomasStorageAccount, err error)
...
// List lists all ThomasStorageAccounts in the indexer.
func (s *thomasStorageAccountLister) List(selector labels.Selector) (ret []*v1alpha1.ThomasStorageAccount, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.ThomasStorageAccount))
	})
	return ret, err
}
...
type ThomasStorageAccountNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.ThomasStorageAccount, error)
...
// List lists all ThomasStorageAccounts in the indexer for a given namespace.
func (s thomasStorageAccountNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.ThomasStorageAccount, err error) {
...
// Get retrieves the ThomasStorageAccount from the indexer for a given namespace and name.
func (s thomasStorageAccountNamespaceLister) Get(name string) (*v1alpha1.ThomasStorageAccount, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("thomasstorageaccount"), name)
	}
	return obj.(*v1alpha1.ThomasStorageAccount), nil
}
