...
type SDPAzSqlv1Lister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.SDPAzSqlv1, err error)
...
// List lists all SDPAzSqlv1s in the indexer.
func (s *sDPAzSqlv1Lister) List(selector labels.Selector) (ret []*v1alpha1.SDPAzSqlv1, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.SDPAzSqlv1))
	})
	return ret, err
}
...
type SDPAzSqlv1NamespaceLister interface {
	...
	Get(name string) (*v1alpha1.SDPAzSqlv1, error)
...
// List lists all SDPAzSqlv1s in the indexer for a given namespace.
func (s sDPAzSqlv1NamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.SDPAzSqlv1, err error) {
...
// Get retrieves the SDPAzSqlv1 from the indexer for a given namespace and name.
func (s sDPAzSqlv1NamespaceLister) Get(name string) (*v1alpha1.SDPAzSqlv1, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("sdpazsqlv1"), name)
	}
	return obj.(*v1alpha1.SDPAzSqlv1), nil
}
