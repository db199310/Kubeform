...
type SDPAzsbv1Lister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.SDPAzsbv1, err error)
...
// List lists all SDPAzsbv1s in the indexer.
func (s *sDPAzsbv1Lister) List(selector labels.Selector) (ret []*v1alpha1.SDPAzsbv1, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.SDPAzsbv1))
	})
	return ret, err
}
...
type SDPAzsbv1NamespaceLister interface {
	...
	Get(name string) (*v1alpha1.SDPAzsbv1, error)
...
// List lists all SDPAzsbv1s in the indexer for a given namespace.
func (s sDPAzsbv1NamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.SDPAzsbv1, err error) {
...
// Get retrieves the SDPAzsbv1 from the indexer for a given namespace and name.
func (s sDPAzsbv1NamespaceLister) Get(name string) (*v1alpha1.SDPAzsbv1, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("sdpazsbv1"), name)
	}
	return obj.(*v1alpha1.SDPAzsbv1), nil
}
