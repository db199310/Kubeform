...
type SDPAzFnv1Lister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.SDPAzFnv1, err error)
...
// List lists all SDPAzFnv1s in the indexer.
func (s *sDPAzFnv1Lister) List(selector labels.Selector) (ret []*v1alpha1.SDPAzFnv1, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.SDPAzFnv1))
	})
	return ret, err
}
...
type SDPAzFnv1NamespaceLister interface {
	...
	Get(name string) (*v1alpha1.SDPAzFnv1, error)
...
// List lists all SDPAzFnv1s in the indexer for a given namespace.
func (s sDPAzFnv1NamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.SDPAzFnv1, err error) {
...
// Get retrieves the SDPAzFnv1 from the indexer for a given namespace and name.
func (s sDPAzFnv1NamespaceLister) Get(name string) (*v1alpha1.SDPAzFnv1, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("sdpazfnv1"), name)
	}
	return obj.(*v1alpha1.SDPAzFnv1), nil
}
