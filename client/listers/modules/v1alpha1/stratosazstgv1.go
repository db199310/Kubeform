...
type StratosAzStgv1Lister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.StratosAzStgv1, err error)
...
// List lists all StratosAzStgv1s in the indexer.
func (s *stratosAzStgv1Lister) List(selector labels.Selector) (ret []*v1alpha1.StratosAzStgv1, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.StratosAzStgv1))
	})
	return ret, err
}
...
type StratosAzStgv1NamespaceLister interface {
	...
	Get(name string) (*v1alpha1.StratosAzStgv1, error)
...
// List lists all StratosAzStgv1s in the indexer for a given namespace.
func (s stratosAzStgv1NamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.StratosAzStgv1, err error) {
...
// Get retrieves the StratosAzStgv1 from the indexer for a given namespace and name.
func (s stratosAzStgv1NamespaceLister) Get(name string) (*v1alpha1.StratosAzStgv1, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("stratosazstgv1"), name)
	}
	return obj.(*v1alpha1.StratosAzStgv1), nil
}
