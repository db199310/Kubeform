	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().Dashboards(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().Dashboards(namespace).Watch(options)
			},
		},
		&azurermv1alpha1.Dashboard{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dashboardInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.Dashboard{}, f.defaultInformer)
}
