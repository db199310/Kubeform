	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().ManagedApplications(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().ManagedApplications(namespace).Watch(options)
			},
		},
		&azurermv1alpha1.ManagedApplication{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *managedApplicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.ManagedApplication{}, f.defaultInformer)
}
