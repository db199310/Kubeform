...
type SDPAzAppv1Informer interface {
	...
	Lister() v1alpha1.SDPAzAppv1Lister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ModulesV1alpha1().SDPAzAppv1s(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ModulesV1alpha1().SDPAzAppv1s(namespace).Watch(context.TODO(), options)
			},
		},
		&modulesv1alpha1.SDPAzAppv1{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sDPAzAppv1Informer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&modulesv1alpha1.SDPAzAppv1{}, f.defaultInformer)
}

func (f *sDPAzAppv1Informer) Lister() v1alpha1.SDPAzAppv1Lister {
	return v1alpha1.NewSDPAzAppv1Lister(f.Informer().GetIndexer())
}
