...
var dedicatedhostsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "dedicatedhosts"}
...
func (c *FakeDedicatedHosts) Get(name string, options v1.GetOptions) (result *v1alpha1.DedicatedHost, err error) {
	...
	return obj.(*v1alpha1.DedicatedHost), err
}
...
func (c *FakeDedicatedHosts) List(opts v1.ListOptions) (result *v1alpha1.DedicatedHostList, err error) {
	...
	list := &v1alpha1.DedicatedHostList{ListMeta: obj.(*v1alpha1.DedicatedHostList).ListMeta}
	for _, item := range obj.(*v1alpha1.DedicatedHostList).Items {
