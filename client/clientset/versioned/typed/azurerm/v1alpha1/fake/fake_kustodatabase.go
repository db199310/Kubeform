...
// FakeKustoDatabases implements KustoDatabaseInterface
type FakeKustoDatabases struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var kustodatabasesResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "kustodatabases"}
...
func (c *FakeKustoDatabases) Get(name string, options v1.GetOptions) (result *v1alpha1.KustoDatabase, err error) {
	...
	return obj.(*v1alpha1.KustoDatabase), err
}
...
func (c *FakeKustoDatabases) List(opts v1.ListOptions) (result *v1alpha1.KustoDatabaseList, err error) {
	...
	list := &v1alpha1.KustoDatabaseList{ListMeta: obj.(*v1alpha1.KustoDatabaseList).ListMeta}
	for _, item := range obj.(*v1alpha1.KustoDatabaseList).Items {
