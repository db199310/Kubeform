...
// FakeKustoDatabasePrincipals implements KustoDatabasePrincipalInterface
type FakeKustoDatabasePrincipals struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var kustodatabaseprincipalsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "kustodatabaseprincipals"}
...
func (c *FakeKustoDatabasePrincipals) Get(name string, options v1.GetOptions) (result *v1alpha1.KustoDatabasePrincipal, err error) {
	...
	return obj.(*v1alpha1.KustoDatabasePrincipal), err
}
...
func (c *FakeKustoDatabasePrincipals) List(opts v1.ListOptions) (result *v1alpha1.KustoDatabasePrincipalList, err error) {
	...
	list := &v1alpha1.KustoDatabasePrincipalList{ListMeta: obj.(*v1alpha1.KustoDatabasePrincipalList).ListMeta}
	for _, item := range obj.(*v1alpha1.KustoDatabasePrincipalList).Items {
