...
// FakeSubnetNATGatewayAssociations implements SubnetNATGatewayAssociationInterface
type FakeSubnetNATGatewayAssociations struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var subnetnatgatewayassociationsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "subnetnatgatewayassociations"}
...
func (c *FakeSubnetNATGatewayAssociations) Get(name string, options v1.GetOptions) (result *v1alpha1.SubnetNATGatewayAssociation, err error) {
	...
	return obj.(*v1alpha1.SubnetNATGatewayAssociation), err
}
...
func (c *FakeSubnetNATGatewayAssociations) List(opts v1.ListOptions) (result *v1alpha1.SubnetNATGatewayAssociationList, err error) {
	...
	list := &v1alpha1.SubnetNATGatewayAssociationList{ListMeta: obj.(*v1alpha1.SubnetNATGatewayAssociationList).ListMeta}
	for _, item := range obj.(*v1alpha1.SubnetNATGatewayAssociationList).Items {
