...
// FakeKustoEventhubDataConnections implements KustoEventhubDataConnectionInterface
type FakeKustoEventhubDataConnections struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var kustoeventhubdataconnectionsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "kustoeventhubdataconnections"}
...
func (c *FakeKustoEventhubDataConnections) Get(name string, options v1.GetOptions) (result *v1alpha1.KustoEventhubDataConnection, err error) {
	...
	return obj.(*v1alpha1.KustoEventhubDataConnection), err
}
...
func (c *FakeKustoEventhubDataConnections) List(opts v1.ListOptions) (result *v1alpha1.KustoEventhubDataConnectionList, err error) {
	...
	list := &v1alpha1.KustoEventhubDataConnectionList{ListMeta: obj.(*v1alpha1.KustoEventhubDataConnectionList).ListMeta}
	for _, item := range obj.(*v1alpha1.KustoEventhubDataConnectionList).Items {
