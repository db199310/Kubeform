...
// FakeApplicationInsightsAnalyticsItems implements ApplicationInsightsAnalyticsItemInterface
type FakeApplicationInsightsAnalyticsItems struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var applicationinsightsanalyticsitemsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "applicationinsightsanalyticsitems"}
...
func (c *FakeApplicationInsightsAnalyticsItems) Get(name string, options v1.GetOptions) (result *v1alpha1.ApplicationInsightsAnalyticsItem, err error) {
	...
	return obj.(*v1alpha1.ApplicationInsightsAnalyticsItem), err
}
...
func (c *FakeApplicationInsightsAnalyticsItems) List(opts v1.ListOptions) (result *v1alpha1.ApplicationInsightsAnalyticsItemList, err error) {
	...
	list := &v1alpha1.ApplicationInsightsAnalyticsItemList{ListMeta: obj.(*v1alpha1.ApplicationInsightsAnalyticsItemList).ListMeta}
	for _, item := range obj.(*v1alpha1.ApplicationInsightsAnalyticsItemList).Items {
