...
// FakeSiteRecoveryProtectionContainers implements SiteRecoveryProtectionContainerInterface
type FakeSiteRecoveryProtectionContainers struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var siterecoveryprotectioncontainersResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "siterecoveryprotectioncontainers"}
...
func (c *FakeSiteRecoveryProtectionContainers) Get(name string, options v1.GetOptions) (result *v1alpha1.SiteRecoveryProtectionContainer, err error) {
	...
	return obj.(*v1alpha1.SiteRecoveryProtectionContainer), err
}
...
func (c *FakeSiteRecoveryProtectionContainers) List(opts v1.ListOptions) (result *v1alpha1.SiteRecoveryProtectionContainerList, err error) {
	...
	list := &v1alpha1.SiteRecoveryProtectionContainerList{ListMeta: obj.(*v1alpha1.SiteRecoveryProtectionContainerList).ListMeta}
	for _, item := range obj.(*v1alpha1.SiteRecoveryProtectionContainerList).Items {
