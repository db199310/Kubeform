...
// FakeVpnServerConfigurations implements VpnServerConfigurationInterface
type FakeVpnServerConfigurations struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var vpnserverconfigurationsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "vpnserverconfigurations"}
...
func (c *FakeVpnServerConfigurations) Get(name string, options v1.GetOptions) (result *v1alpha1.VpnServerConfiguration, err error) {
	...
	return obj.(*v1alpha1.VpnServerConfiguration), err
}
...
func (c *FakeVpnServerConfigurations) List(opts v1.ListOptions) (result *v1alpha1.VpnServerConfigurationList, err error) {
	...
	list := &v1alpha1.VpnServerConfigurationList{ListMeta: obj.(*v1alpha1.VpnServerConfigurationList).ListMeta}
	for _, item := range obj.(*v1alpha1.VpnServerConfigurationList).Items {
