...
// FakeBotChannelsRegistrations implements BotChannelsRegistrationInterface
type FakeBotChannelsRegistrations struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var botchannelsregistrationsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "botchannelsregistrations"}
...
func (c *FakeBotChannelsRegistrations) Get(name string, options v1.GetOptions) (result *v1alpha1.BotChannelsRegistration, err error) {
	...
	return obj.(*v1alpha1.BotChannelsRegistration), err
}
...
func (c *FakeBotChannelsRegistrations) List(opts v1.ListOptions) (result *v1alpha1.BotChannelsRegistrationList, err error) {
	...
	list := &v1alpha1.BotChannelsRegistrationList{ListMeta: obj.(*v1alpha1.BotChannelsRegistrationList).ListMeta}
	for _, item := range obj.(*v1alpha1.BotChannelsRegistrationList).Items {
