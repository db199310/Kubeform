...
// FakeBastionHosts implements BastionHostInterface
type FakeBastionHosts struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var bastionhostsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "bastionhosts"}
...
func (c *FakeBastionHosts) Get(name string, options v1.GetOptions) (result *v1alpha1.BastionHost, err error) {
	...
	return obj.(*v1alpha1.BastionHost), err
}
...
func (c *FakeBastionHosts) List(opts v1.ListOptions) (result *v1alpha1.BastionHostList, err error) {
	...
	list := &v1alpha1.BastionHostList{ListMeta: obj.(*v1alpha1.BastionHostList).ListMeta}
	for _, item := range obj.(*v1alpha1.BastionHostList).Items {
