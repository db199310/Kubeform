...
var mssqlserversResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "mssqlservers"}

var mssqlserversKind = schema.GroupVersionKind{Group: "azurerm.kubeform.com", Version: "v1alpha1", Kind: "MssqlServer"}

// Get takes name of the mssqlServer, and returns the corresponding mssqlServer object, and an error if there is any.
func (c *FakeMssqlServers) Get(name string, options v1.GetOptions) (result *v1alpha1.MssqlServer, err error) {
	obj, err := c.Fake.
...
func (c *FakeMssqlServers) List(opts v1.ListOptions) (result *v1alpha1.MssqlServerList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMssqlServers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeMssqlServers) Create(mssqlServer *v1alpha1.MssqlServer) (result *v1alpha1.MssqlServer, err error) {
	obj, err := c.Fake.
...
func (c *FakeMssqlServers) Update(mssqlServer *v1alpha1.MssqlServer) (result *v1alpha1.MssqlServer, err error) {
	obj, err := c.Fake.
...
func (c *FakeMssqlServers) UpdateStatus(mssqlServer *v1alpha1.MssqlServer) (*v1alpha1.MssqlServer, error) {
	obj, err := c.Fake.
...
func (c *FakeMssqlServers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(mssqlserversResource, c.ns, name), &v1alpha1.MssqlServer{})

	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeMssqlServers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(mssqlserversResource, c.ns, listOptions)
...
func (c *FakeMssqlServers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MssqlServer, err error) {
	obj, err := c.Fake.
