...
// FakePrivateEndpoints implements PrivateEndpointInterface
type FakePrivateEndpoints struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var privateendpointsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "privateendpoints"}
...
func (c *FakePrivateEndpoints) Get(name string, options v1.GetOptions) (result *v1alpha1.PrivateEndpoint, err error) {
	...
	return obj.(*v1alpha1.PrivateEndpoint), err
}
...
func (c *FakePrivateEndpoints) List(opts v1.ListOptions) (result *v1alpha1.PrivateEndpointList, err error) {
	...
	list := &v1alpha1.PrivateEndpointList{ListMeta: obj.(*v1alpha1.PrivateEndpointList).ListMeta}
	for _, item := range obj.(*v1alpha1.PrivateEndpointList).Items {
