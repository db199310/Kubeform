...
// FakeApiManagementIdentityProviderGoogles implements ApiManagementIdentityProviderGoogleInterface
type FakeApiManagementIdentityProviderGoogles struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var apimanagementidentityprovidergooglesResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "apimanagementidentityprovidergoogles"}
...
func (c *FakeApiManagementIdentityProviderGoogles) Get(name string, options v1.GetOptions) (result *v1alpha1.ApiManagementIdentityProviderGoogle, err error) {
	...
	return obj.(*v1alpha1.ApiManagementIdentityProviderGoogle), err
}
...
func (c *FakeApiManagementIdentityProviderGoogles) List(opts v1.ListOptions) (result *v1alpha1.ApiManagementIdentityProviderGoogleList, err error) {
	...
	list := &v1alpha1.ApiManagementIdentityProviderGoogleList{ListMeta: obj.(*v1alpha1.ApiManagementIdentityProviderGoogleList).ListMeta}
	for _, item := range obj.(*v1alpha1.ApiManagementIdentityProviderGoogleList).Items {
