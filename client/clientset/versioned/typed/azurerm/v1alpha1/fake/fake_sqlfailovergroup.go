...
// FakeSqlFailoverGroups implements SqlFailoverGroupInterface
type FakeSqlFailoverGroups struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var sqlfailovergroupsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "sqlfailovergroups"}
...
func (c *FakeSqlFailoverGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.SqlFailoverGroup, err error) {
	...
	return obj.(*v1alpha1.SqlFailoverGroup), err
}
...
func (c *FakeSqlFailoverGroups) List(opts v1.ListOptions) (result *v1alpha1.SqlFailoverGroupList, err error) {
	...
	list := &v1alpha1.SqlFailoverGroupList{ListMeta: obj.(*v1alpha1.SqlFailoverGroupList).ListMeta}
	for _, item := range obj.(*v1alpha1.SqlFailoverGroupList).Items {
