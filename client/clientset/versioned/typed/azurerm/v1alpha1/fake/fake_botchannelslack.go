...
// FakeBotChannelSlacks implements BotChannelSlackInterface
type FakeBotChannelSlacks struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var botchannelslacksResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "botchannelslacks"}
...
func (c *FakeBotChannelSlacks) Get(name string, options v1.GetOptions) (result *v1alpha1.BotChannelSlack, err error) {
	...
	return obj.(*v1alpha1.BotChannelSlack), err
}
...
func (c *FakeBotChannelSlacks) List(opts v1.ListOptions) (result *v1alpha1.BotChannelSlackList, err error) {
	...
	list := &v1alpha1.BotChannelSlackList{ListMeta: obj.(*v1alpha1.BotChannelSlackList).ListMeta}
	for _, item := range obj.(*v1alpha1.BotChannelSlackList).Items {
