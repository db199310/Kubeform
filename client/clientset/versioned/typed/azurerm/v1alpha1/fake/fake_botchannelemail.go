...
// FakeBotChannelEmails implements BotChannelEmailInterface
type FakeBotChannelEmails struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var botchannelemailsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "botchannelemails"}
...
func (c *FakeBotChannelEmails) Get(name string, options v1.GetOptions) (result *v1alpha1.BotChannelEmail, err error) {
	...
	return obj.(*v1alpha1.BotChannelEmail), err
}
...
func (c *FakeBotChannelEmails) List(opts v1.ListOptions) (result *v1alpha1.BotChannelEmailList, err error) {
	...
	list := &v1alpha1.BotChannelEmailList{ListMeta: obj.(*v1alpha1.BotChannelEmailList).ListMeta}
	for _, item := range obj.(*v1alpha1.BotChannelEmailList).Items {
