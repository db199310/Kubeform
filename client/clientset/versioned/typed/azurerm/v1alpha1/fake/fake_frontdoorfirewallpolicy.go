...
func (c *FakeFrontdoorFirewallPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.FrontdoorFirewallPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeFrontdoorFirewallPolicies) List(opts v1.ListOptions) (result *v1alpha1.FrontdoorFirewallPolicyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeFrontdoorFirewallPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeFrontdoorFirewallPolicies) Create(frontdoorFirewallPolicy *v1alpha1.FrontdoorFirewallPolicy) (result *v1alpha1.FrontdoorFirewallPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeFrontdoorFirewallPolicies) Update(frontdoorFirewallPolicy *v1alpha1.FrontdoorFirewallPolicy) (result *v1alpha1.FrontdoorFirewallPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeFrontdoorFirewallPolicies) UpdateStatus(frontdoorFirewallPolicy *v1alpha1.FrontdoorFirewallPolicy) (*v1alpha1.FrontdoorFirewallPolicy, error) {
	obj, err := c.Fake.
...
func (c *FakeFrontdoorFirewallPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeFrontdoorFirewallPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(frontdoorfirewallpoliciesResource, c.ns, listOptions)
...
func (c *FakeFrontdoorFirewallPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FrontdoorFirewallPolicy, err error) {
	obj, err := c.Fake.
