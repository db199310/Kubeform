...
// FakeKustoClusters implements KustoClusterInterface
type FakeKustoClusters struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var kustoclustersResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "kustoclusters"}
...
func (c *FakeKustoClusters) Get(name string, options v1.GetOptions) (result *v1alpha1.KustoCluster, err error) {
	...
	return obj.(*v1alpha1.KustoCluster), err
}
...
func (c *FakeKustoClusters) List(opts v1.ListOptions) (result *v1alpha1.KustoClusterList, err error) {
	...
	list := &v1alpha1.KustoClusterList{ListMeta: obj.(*v1alpha1.KustoClusterList).ListMeta}
	for _, item := range obj.(*v1alpha1.KustoClusterList).Items {
