...
// FakeMariadbConfigurations implements MariadbConfigurationInterface
type FakeMariadbConfigurations struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var mariadbconfigurationsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "mariadbconfigurations"}
...
func (c *FakeMariadbConfigurations) Get(name string, options v1.GetOptions) (result *v1alpha1.MariadbConfiguration, err error) {
	...
	return obj.(*v1alpha1.MariadbConfiguration), err
}
...
func (c *FakeMariadbConfigurations) List(opts v1.ListOptions) (result *v1alpha1.MariadbConfigurationList, err error) {
	...
	list := &v1alpha1.MariadbConfigurationList{ListMeta: obj.(*v1alpha1.MariadbConfigurationList).ListMeta}
	for _, item := range obj.(*v1alpha1.MariadbConfigurationList).Items {
