...
// FakeAppServiceSourceControlTokens implements AppServiceSourceControlTokenInterface
type FakeAppServiceSourceControlTokens struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var appservicesourcecontroltokensResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "appservicesourcecontroltokens"}
...
func (c *FakeAppServiceSourceControlTokens) Get(name string, options v1.GetOptions) (result *v1alpha1.AppServiceSourceControlToken, err error) {
	...
	return obj.(*v1alpha1.AppServiceSourceControlToken), err
}
...
func (c *FakeAppServiceSourceControlTokens) List(opts v1.ListOptions) (result *v1alpha1.AppServiceSourceControlTokenList, err error) {
	...
	list := &v1alpha1.AppServiceSourceControlTokenList{ListMeta: obj.(*v1alpha1.AppServiceSourceControlTokenList).ListMeta}
	for _, item := range obj.(*v1alpha1.AppServiceSourceControlTokenList).Items {
