...
// BackupPolicyVmsGetter has a method to return a BackupPolicyVmInterface.
...
// backupPolicyVms implements BackupPolicyVmInterface
type backupPolicyVms struct {
	client rest.Interface
	ns     string
}

// newBackupPolicyVms returns a BackupPolicyVms
func newBackupPolicyVms(c *AzurermV1alpha1Client, namespace string) *backupPolicyVms {
	return &backupPolicyVms{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *backupPolicyVms) List(opts v1.ListOptions) (result *v1alpha1.BackupPolicyVmList, err error) {
	...
	result = &v1alpha1.BackupPolicyVmList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backuppolicyvms").
