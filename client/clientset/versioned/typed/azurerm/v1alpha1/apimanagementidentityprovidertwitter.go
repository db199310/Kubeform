...
// ApiManagementIdentityProviderTwittersGetter has a method to return a ApiManagementIdentityProviderTwitterInterface.
...
// apiManagementIdentityProviderTwitters implements ApiManagementIdentityProviderTwitterInterface
type apiManagementIdentityProviderTwitters struct {
	client rest.Interface
	ns     string
}

// newApiManagementIdentityProviderTwitters returns a ApiManagementIdentityProviderTwitters
func newApiManagementIdentityProviderTwitters(c *AzurermV1alpha1Client, namespace string) *apiManagementIdentityProviderTwitters {
	return &apiManagementIdentityProviderTwitters{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *apiManagementIdentityProviderTwitters) List(opts v1.ListOptions) (result *v1alpha1.ApiManagementIdentityProviderTwitterList, err error) {
	...
	result = &v1alpha1.ApiManagementIdentityProviderTwitterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apimanagementidentityprovidertwitters").
