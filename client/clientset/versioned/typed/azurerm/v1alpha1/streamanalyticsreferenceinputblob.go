...
type StreamAnalyticsReferenceInputBlobInterface interface {
	Create(*v1alpha1.StreamAnalyticsReferenceInputBlob) (*v1alpha1.StreamAnalyticsReferenceInputBlob, error)
	Update(*v1alpha1.StreamAnalyticsReferenceInputBlob) (*v1alpha1.StreamAnalyticsReferenceInputBlob, error)
	UpdateStatus(*v1alpha1.StreamAnalyticsReferenceInputBlob) (*v1alpha1.StreamAnalyticsReferenceInputBlob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.StreamAnalyticsReferenceInputBlob, error)
	List(opts v1.ListOptions) (*v1alpha1.StreamAnalyticsReferenceInputBlobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StreamAnalyticsReferenceInputBlob, err error)
...
func (c *streamAnalyticsReferenceInputBlobs) Get(name string, options v1.GetOptions) (result *v1alpha1.StreamAnalyticsReferenceInputBlob, err error) {
...
func (c *streamAnalyticsReferenceInputBlobs) List(opts v1.ListOptions) (result *v1alpha1.StreamAnalyticsReferenceInputBlobList, err error) {
...
func (c *streamAnalyticsReferenceInputBlobs) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *streamAnalyticsReferenceInputBlobs) Create(streamAnalyticsReferenceInputBlob *v1alpha1.StreamAnalyticsReferenceInputBlob) (result *v1alpha1.StreamAnalyticsReferenceInputBlob, err error) {
	result = &v1alpha1.StreamAnalyticsReferenceInputBlob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("streamanalyticsreferenceinputblobs").
...
func (c *streamAnalyticsReferenceInputBlobs) Update(streamAnalyticsReferenceInputBlob *v1alpha1.StreamAnalyticsReferenceInputBlob) (result *v1alpha1.StreamAnalyticsReferenceInputBlob, err error) {
	result = &v1alpha1.StreamAnalyticsReferenceInputBlob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("streamanalyticsreferenceinputblobs").
...
func (c *streamAnalyticsReferenceInputBlobs) UpdateStatus(streamAnalyticsReferenceInputBlob *v1alpha1.StreamAnalyticsReferenceInputBlob) (result *v1alpha1.StreamAnalyticsReferenceInputBlob, err error) {
	result = &v1alpha1.StreamAnalyticsReferenceInputBlob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("streamanalyticsreferenceinputblobs").
...
func (c *streamAnalyticsReferenceInputBlobs) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *streamAnalyticsReferenceInputBlobs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *streamAnalyticsReferenceInputBlobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StreamAnalyticsReferenceInputBlob, err error) {
	result = &v1alpha1.StreamAnalyticsReferenceInputBlob{}
