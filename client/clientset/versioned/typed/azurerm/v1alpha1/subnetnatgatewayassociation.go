...
type SubnetNATGatewayAssociationInterface interface {
	Create(*v1alpha1.SubnetNATGatewayAssociation) (*v1alpha1.SubnetNATGatewayAssociation, error)
	Update(*v1alpha1.SubnetNATGatewayAssociation) (*v1alpha1.SubnetNATGatewayAssociation, error)
	UpdateStatus(*v1alpha1.SubnetNATGatewayAssociation) (*v1alpha1.SubnetNATGatewayAssociation, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SubnetNATGatewayAssociation, error)
	List(opts v1.ListOptions) (*v1alpha1.SubnetNATGatewayAssociationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SubnetNATGatewayAssociation, err error)
...
func (c *subnetNATGatewayAssociations) Get(name string, options v1.GetOptions) (result *v1alpha1.SubnetNATGatewayAssociation, err error) {
...
func (c *subnetNATGatewayAssociations) List(opts v1.ListOptions) (result *v1alpha1.SubnetNATGatewayAssociationList, err error) {
...
func (c *subnetNATGatewayAssociations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *subnetNATGatewayAssociations) Create(subnetNATGatewayAssociation *v1alpha1.SubnetNATGatewayAssociation) (result *v1alpha1.SubnetNATGatewayAssociation, err error) {
	result = &v1alpha1.SubnetNATGatewayAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("subnetnatgatewayassociations").
...
func (c *subnetNATGatewayAssociations) Update(subnetNATGatewayAssociation *v1alpha1.SubnetNATGatewayAssociation) (result *v1alpha1.SubnetNATGatewayAssociation, err error) {
	result = &v1alpha1.SubnetNATGatewayAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subnetnatgatewayassociations").
...
func (c *subnetNATGatewayAssociations) UpdateStatus(subnetNATGatewayAssociation *v1alpha1.SubnetNATGatewayAssociation) (result *v1alpha1.SubnetNATGatewayAssociation, err error) {
	result = &v1alpha1.SubnetNATGatewayAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subnetnatgatewayassociations").
...
func (c *subnetNATGatewayAssociations) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *subnetNATGatewayAssociations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *subnetNATGatewayAssociations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SubnetNATGatewayAssociation, err error) {
	result = &v1alpha1.SubnetNATGatewayAssociation{}
