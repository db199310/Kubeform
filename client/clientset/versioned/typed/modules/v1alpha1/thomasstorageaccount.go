...
type ThomasStorageAccountInterface interface {
	Create(*v1alpha1.ThomasStorageAccount) (*v1alpha1.ThomasStorageAccount, error)
	Update(*v1alpha1.ThomasStorageAccount) (*v1alpha1.ThomasStorageAccount, error)
	UpdateStatus(*v1alpha1.ThomasStorageAccount) (*v1alpha1.ThomasStorageAccount, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ThomasStorageAccount, error)
	List(opts v1.ListOptions) (*v1alpha1.ThomasStorageAccountList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ThomasStorageAccount, err error)
...
func (c *thomasStorageAccounts) Get(name string, options v1.GetOptions) (result *v1alpha1.ThomasStorageAccount, err error) {
...
func (c *thomasStorageAccounts) List(opts v1.ListOptions) (result *v1alpha1.ThomasStorageAccountList, err error) {
...
func (c *thomasStorageAccounts) Create(thomasStorageAccount *v1alpha1.ThomasStorageAccount) (result *v1alpha1.ThomasStorageAccount, err error) {
	result = &v1alpha1.ThomasStorageAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("thomasstorageaccounts").
...
func (c *thomasStorageAccounts) Update(thomasStorageAccount *v1alpha1.ThomasStorageAccount) (result *v1alpha1.ThomasStorageAccount, err error) {
	result = &v1alpha1.ThomasStorageAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("thomasstorageaccounts").
...
func (c *thomasStorageAccounts) UpdateStatus(thomasStorageAccount *v1alpha1.ThomasStorageAccount) (result *v1alpha1.ThomasStorageAccount, err error) {
	result = &v1alpha1.ThomasStorageAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("thomasstorageaccounts").
...
func (c *thomasStorageAccounts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ThomasStorageAccount, err error) {
	result = &v1alpha1.ThomasStorageAccount{}
