...
type SDPAzsbv1Interface interface {
	Create(*v1alpha1.SDPAzsbv1) (*v1alpha1.SDPAzsbv1, error)
	Update(*v1alpha1.SDPAzsbv1) (*v1alpha1.SDPAzsbv1, error)
	UpdateStatus(*v1alpha1.SDPAzsbv1) (*v1alpha1.SDPAzsbv1, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SDPAzsbv1, error)
	List(opts v1.ListOptions) (*v1alpha1.SDPAzsbv1List, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SDPAzsbv1, err error)
	SDPAzsbv1Expansion
}
...
func (c *sDPAzsbv1s) Get(name string, options v1.GetOptions) (result *v1alpha1.SDPAzsbv1, err error) {
...
func (c *sDPAzsbv1s) List(opts v1.ListOptions) (result *v1alpha1.SDPAzsbv1List, err error) {
...
func (c *sDPAzsbv1s) Create(sDPAzsbv1 *v1alpha1.SDPAzsbv1) (result *v1alpha1.SDPAzsbv1, err error) {
	result = &v1alpha1.SDPAzsbv1{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sdpazsbv1s").
...
func (c *sDPAzsbv1s) Update(sDPAzsbv1 *v1alpha1.SDPAzsbv1) (result *v1alpha1.SDPAzsbv1, err error) {
	result = &v1alpha1.SDPAzsbv1{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sdpazsbv1s").
...
func (c *sDPAzsbv1s) UpdateStatus(sDPAzsbv1 *v1alpha1.SDPAzsbv1) (result *v1alpha1.SDPAzsbv1, err error) {
	result = &v1alpha1.SDPAzsbv1{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sdpazsbv1s").
...
func (c *sDPAzsbv1s) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SDPAzsbv1, err error) {
	result = &v1alpha1.SDPAzsbv1{}
