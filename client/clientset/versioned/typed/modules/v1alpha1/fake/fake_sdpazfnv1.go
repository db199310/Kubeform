...
func (c *FakeSDPAzFnv1s) Get(name string, options v1.GetOptions) (result *v1alpha1.SDPAzFnv1, err error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzFnv1s) List(opts v1.ListOptions) (result *v1alpha1.SDPAzFnv1List, err error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzFnv1s) Create(sDPAzFnv1 *v1alpha1.SDPAzFnv1) (result *v1alpha1.SDPAzFnv1, err error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzFnv1s) Update(sDPAzFnv1 *v1alpha1.SDPAzFnv1) (result *v1alpha1.SDPAzFnv1, err error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzFnv1s) UpdateStatus(sDPAzFnv1 *v1alpha1.SDPAzFnv1) (*v1alpha1.SDPAzFnv1, error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzFnv1s) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SDPAzFnv1, err error) {
	obj, err := c.Fake.
