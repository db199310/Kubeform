...
func (c *FakeSDPAzcosmosdbv1s) Get(name string, options v1.GetOptions) (result *v1alpha1.SDPAzcosmosdbv1, err error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzcosmosdbv1s) List(opts v1.ListOptions) (result *v1alpha1.SDPAzcosmosdbv1List, err error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzcosmosdbv1s) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSDPAzcosmosdbv1s) Create(sDPAzcosmosdbv1 *v1alpha1.SDPAzcosmosdbv1) (result *v1alpha1.SDPAzcosmosdbv1, err error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzcosmosdbv1s) Update(sDPAzcosmosdbv1 *v1alpha1.SDPAzcosmosdbv1) (result *v1alpha1.SDPAzcosmosdbv1, err error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzcosmosdbv1s) UpdateStatus(sDPAzcosmosdbv1 *v1alpha1.SDPAzcosmosdbv1) (*v1alpha1.SDPAzcosmosdbv1, error) {
	obj, err := c.Fake.
...
func (c *FakeSDPAzcosmosdbv1s) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeSDPAzcosmosdbv1s) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sdpazcosmosdbv1sResource, c.ns, listOptions)
...
func (c *FakeSDPAzcosmosdbv1s) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SDPAzcosmosdbv1, err error) {
	obj, err := c.Fake.
