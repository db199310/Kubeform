...
var sdpazsqlv1sResource = schema.GroupVersionResource{Group: "modules.kubeform.com", Version: "v1alpha1", Resource: "sdpazsqlv1s"}
...
func (c *FakeSDPAzSqlv1s) Get(name string, options v1.GetOptions) (result *v1alpha1.SDPAzSqlv1, err error) {
	...
	return obj.(*v1alpha1.SDPAzSqlv1), err
}
...
func (c *FakeSDPAzSqlv1s) List(opts v1.ListOptions) (result *v1alpha1.SDPAzSqlv1List, err error) {
	...
	list := &v1alpha1.SDPAzSqlv1List{ListMeta: obj.(*v1alpha1.SDPAzSqlv1List).ListMeta}
	for _, item := range obj.(*v1alpha1.SDPAzSqlv1List).Items {
