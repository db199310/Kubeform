...
type SDPAzadfv1Interface interface {
	Create(*v1alpha1.SDPAzadfv1) (*v1alpha1.SDPAzadfv1, error)
	Update(*v1alpha1.SDPAzadfv1) (*v1alpha1.SDPAzadfv1, error)
	UpdateStatus(*v1alpha1.SDPAzadfv1) (*v1alpha1.SDPAzadfv1, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SDPAzadfv1, error)
	List(opts v1.ListOptions) (*v1alpha1.SDPAzadfv1List, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SDPAzadfv1, err error)
	SDPAzadfv1Expansion
}
...
func (c *sDPAzadfv1s) Get(name string, options v1.GetOptions) (result *v1alpha1.SDPAzadfv1, err error) {
...
func (c *sDPAzadfv1s) List(opts v1.ListOptions) (result *v1alpha1.SDPAzadfv1List, err error) {
...
func (c *sDPAzadfv1s) Create(sDPAzadfv1 *v1alpha1.SDPAzadfv1) (result *v1alpha1.SDPAzadfv1, err error) {
	result = &v1alpha1.SDPAzadfv1{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sdpazadfv1s").
...
func (c *sDPAzadfv1s) Update(sDPAzadfv1 *v1alpha1.SDPAzadfv1) (result *v1alpha1.SDPAzadfv1, err error) {
	result = &v1alpha1.SDPAzadfv1{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sdpazadfv1s").
...
func (c *sDPAzadfv1s) UpdateStatus(sDPAzadfv1 *v1alpha1.SDPAzadfv1) (result *v1alpha1.SDPAzadfv1, err error) {
	result = &v1alpha1.SDPAzadfv1{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sdpazadfv1s").
...
func (c *sDPAzadfv1s) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SDPAzadfv1, err error) {
	result = &v1alpha1.SDPAzadfv1{}
