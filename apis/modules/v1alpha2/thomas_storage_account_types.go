...
type ThomasStorageAccount struct {
	metav1.TypeMeta   `json:",inline,omitempty"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              ThomasStorageAccountSpec   `json:"spec,omitempty"`
	Status            ThomasStorageAccountStatus `json:"status,omitempty"`
}

type ThomasStorageAccountSpec struct {
	// +optional
	...
	// +optional
	// List of Blobs
	Blobs []ThomasStorageAccountBlobs `json:"blobs,omitempty" tf:"blobs,omitempty"`
	// +optional
	// The name of the resource group in which to create the storage account. Changing this forces a new resource to be created.
	Containers []string `json:"containers,omitempty" tf:"containers,omitempty"`
	// +optional
	// Creates a default container
	DefaultContainer string `json:"defaultContainer,omitempty" tf:"default_container,omitempty"`
	...
	Shares []ThomasStorageAccountShares `json:"shares,omitempty" tf:"shares,omitempty"`
	// +optional
...
type ThomasStorageAccountBlobs struct {
	// +optional
...
type ThomasStorageAccountShares struct {
	// +optional
	Name string `json:"name,omitempty" tf:"name,omitempty"`
	// +optional
...
type ThomasStorageAccountOutput struct {
	//
	// +optional
	StorageAccountName string `json:"storageAccountName" tf:"storage_account_name"`
}

type ThomasStorageAccountStatus struct {
	// Resource generation, which is updated on mutation by the API Server.
	// +optional
	ObservedGeneration int64 `json:"observedGeneration,omitempty"`
	// +optional
	Output *ThomasStorageAccountOutput `json:"output,omitempty"`
	// +optional
...
// ThomasStorageAccountList is a list of ThomasStorageAccounts
type ThomasStorageAccountList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of ThomasStorageAccount CRD objects
	Items []ThomasStorageAccount `json:"items,omitempty"`
}
