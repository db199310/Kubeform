...
type F4dpAzFnv1 struct {
	metav1.TypeMeta   `json:",inline,omitempty"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              F4dpAzFnv1Spec   `json:"spec,omitempty"`
	Status            F4dpAzFnv1Status `json:"status,omitempty"`
}

type F4dpAzFnv1Spec struct {
	// +optional
	...
	AuthSettings map[string]F4dpAzFnv1AuthSettings `json:"authSettings,omitempty" tf:"auth_settings,omitempty"`
	// +optional
	...
	ConnectionStrings []F4dpAzFnv1ConnectionStrings `json:"connectionStrings,omitempty" tf:"connection_strings,omitempty"`
	// +optional
	...
	SiteConfig map[string]F4dpAzFnv1SiteConfig `json:"siteConfig,omitempty" tf:"site_config,omitempty"`
	// +optional
	// Site config core parameters for Fn app
	SiteConfigCors map[string]F4dpAzFnv1SiteConfigCors `json:"siteConfigCors,omitempty" tf:"site_config_cors,omitempty"`
	// +optional
...
type F4dpAzFnv1AuthSettings struct {
	// +optional
	AuthEnabled *bool `json:"authEnabled,omitempty" tf:"auth_enabled,omitempty"`
}

type F4dpAzFnv1ConnectionStrings struct {
	// +optional
...
type F4dpAzFnv1SiteConfig struct {
	// +optional
...
type F4dpAzFnv1SiteConfigCors struct {
	// +optional
...
type F4dpAzFnv1Output struct {
	// Map output of the Fnapp Services
	// +optional
	FnApp string `json:"fnApp" tf:"fn_app"`
}

type F4dpAzFnv1Status struct {
	// Resource generation, which is updated on mutation by the API Server.
	// +optional
	ObservedGeneration int64 `json:"observedGeneration,omitempty"`
	// +optional
	Output *F4dpAzFnv1Output `json:"output,omitempty"`
	// +optional
...
// F4dpAzFnv1List is a list of F4dpAzFnv1s
type F4dpAzFnv1List struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of F4dpAzFnv1 CRD objects
	Items []F4dpAzFnv1 `json:"items,omitempty"`
}
