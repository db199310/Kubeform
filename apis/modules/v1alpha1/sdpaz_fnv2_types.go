...
type SDPAzFnv2 struct {
	metav1.TypeMeta   `json:",inline,omitempty"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              SDPAzFnv2Spec   `json:"spec,omitempty"`
	Status            SDPAzFnv2Status `json:"status,omitempty"`
}

type SDPAzFnv2Spec struct {
	// +optional
	...
	AuthSettings map[string]SDPAzFnv2AuthSettings `json:"authSettings,omitempty" tf:"auth_settings,omitempty"`
	// +optional
	// connection strings for fn app
	ConnectionStrings []SDPAzFnv2ConnectionStrings `json:"connectionStrings,omitempty" tf:"connection_strings,omitempty"`
	...
	SiteConfig map[string]SDPAzFnv2SiteConfig `json:"siteConfig,omitempty" tf:"site_config,omitempty"`
	// +optional
	// Site config core parameters for Fn app
	SiteConfigCors map[string]SDPAzFnv2SiteConfigCors `json:"siteConfigCors,omitempty" tf:"site_config_cors,omitempty"`
	// +optional
...
type SDPAzFnv2AuthSettings struct {
	// +optional
	AuthEnabled *bool `json:"authEnabled,omitempty" tf:"auth_enabled,omitempty"`
}

type SDPAzFnv2ConnectionStrings struct {
	// +optional
...
type SDPAzFnv2SiteConfig struct {
	// +optional
...
type SDPAzFnv2SiteConfigCors struct {
	// +optional
...
type SDPAzFnv2Output struct{}

type SDPAzFnv2Status struct {
	// Resource generation, which is updated on mutation by the API Server.
	// +optional
	ObservedGeneration int64 `json:"observedGeneration,omitempty"`
	// +optional
	Output *SDPAzFnv2Output `json:"output,omitempty"`
	// +optional
...
// SDPAzFnv2List is a list of SDPAzFnv2s
type SDPAzFnv2List struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of SDPAzFnv2 CRD objects
	Items []SDPAzFnv2 `json:"items,omitempty"`
}
