...
type SDPAzStgv1 struct {
	metav1.TypeMeta   `json:",inline,omitempty"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              SDPAzStgv1Spec   `json:"spec,omitempty"`
	Status            SDPAzStgv1Status `json:"status,omitempty"`
}

type SDPAzStgv1Spec struct {
	// +optional
	...
	// +optional
	// List of Blobs
	Blobs []SDPAzStgv1Blobs `json:"blobs,omitempty" tf:"blobs,omitempty"`
	// +optional
	...
	Shares []SDPAzStgv1Shares `json:"shares,omitempty" tf:"shares,omitempty"`
	// +optional
	// The vnet subnet id
...
type SDPAzStgv1Output struct {
	//
	// +optional
	StorageAccountName string `json:"storageAccountName" tf:"storage_account_name"`
}

type SDPAzStgv1Status struct {
	// Resource generation, which is updated on mutation by the API Server.
	// +optional
	ObservedGeneration int64 `json:"observedGeneration,omitempty"`
	// +optional
	Output *SDPAzStgv1Output `json:"output,omitempty"`
	// +optional
...
// SDPAzStgv1List is a list of SDPAzStgv1s
type SDPAzStgv1List struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of SDPAzStgv1 CRD objects
	Items []SDPAzStgv1 `json:"items,omitempty"`
}
