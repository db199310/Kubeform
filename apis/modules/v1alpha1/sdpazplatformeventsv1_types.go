...
type SDPAzplatformeventsv1 struct {
	metav1.TypeMeta   `json:",inline,omitempty"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              SDPAzplatformeventsv1Spec   `json:"spec,omitempty"`
	Status            SDPAzplatformeventsv1Status `json:"status,omitempty"`
}

type SDPAzplatformeventsv1Spec struct {
	// +optional
	...
	// The name of the Platform ServiceBus Namespace
	...
	// The name of an existing resource group for the Platform ServiceBus Namespace
...
type SDPAzplatformeventsv1Output struct{}

type SDPAzplatformeventsv1Status struct {
	// Resource generation, which is updated on mutation by the API Server.
	// +optional
	ObservedGeneration int64 `json:"observedGeneration,omitempty"`
	// +optional
	Output *SDPAzplatformeventsv1Output `json:"output,omitempty"`
	// +optional
...
// SDPAzplatformeventsv1List is a list of SDPAzplatformeventsv1s
type SDPAzplatformeventsv1List struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of SDPAzplatformeventsv1 CRD objects
	Items []SDPAzplatformeventsv1 `json:"items,omitempty"`
}
