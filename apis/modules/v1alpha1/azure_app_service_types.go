...
type AzureAppServiceSpec struct {
	...
	AppService map[string]AzureAppServiceAppService `json:"appService,omitempty" tf:"app_service,omitempty"`
	// +optional
	...
	AppServicePrefix string `json:"appServicePrefix" tf:"app_service_prefix"`
	// The App Service resources group name.
	AppServiceRg string `json:"appServiceRg" tf:"app_service_rg"`
	// +optional
	AppSettings       map[string]string `json:"appSettings,omitempty" tf:"app_settings,omitempty"`
	AppservicePlanKey string            `json:"appservicePlanKey" tf:"appservice_plan_key"`
	// +optional
	...
	// +optional
	SiteConfig map[string]AzureAppServiceSiteConfig `json:"siteConfig,omitempty" tf:"site_config,omitempty"`
	// +optional
	SiteConfigCors map[string]AzureAppServiceSiteConfigCors `json:"siteConfigCors,omitempty" tf:"site_config_cors,omitempty"`
	// +optional
