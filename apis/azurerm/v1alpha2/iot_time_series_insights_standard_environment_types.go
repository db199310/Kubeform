...
type IotTimeSeriesInsightsStandardEnvironment struct {
	...
	Spec              IotTimeSeriesInsightsStandardEnvironmentSpec   `json:"spec,omitempty"`
...
type IotTimeSeriesInsightsStandardEnvironmentStatus struct {
	...
	// +optional
	Output *IotTimeSeriesInsightsStandardEnvironmentSpec `json:"output,omitempty"`
	// +optional
...
// IotTimeSeriesInsightsStandardEnvironmentList is a list of IotTimeSeriesInsightsStandardEnvironments
type IotTimeSeriesInsightsStandardEnvironmentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of IotTimeSeriesInsightsStandardEnvironment CRD objects
	Items []IotTimeSeriesInsightsStandardEnvironment `json:"items,omitempty"`
}
