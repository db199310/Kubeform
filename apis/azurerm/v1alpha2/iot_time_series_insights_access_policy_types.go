...
type IotTimeSeriesInsightsAccessPolicy struct {
	...
	Spec              IotTimeSeriesInsightsAccessPolicySpec   `json:"spec,omitempty"`
...
type IotTimeSeriesInsightsAccessPolicyStatus struct {
	...
	// +optional
	Output *IotTimeSeriesInsightsAccessPolicySpec `json:"output,omitempty"`
	// +optional
...
// IotTimeSeriesInsightsAccessPolicyList is a list of IotTimeSeriesInsightsAccessPolicys
type IotTimeSeriesInsightsAccessPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of IotTimeSeriesInsightsAccessPolicy CRD objects
	Items []IotTimeSeriesInsightsAccessPolicy `json:"items,omitempty"`
}
