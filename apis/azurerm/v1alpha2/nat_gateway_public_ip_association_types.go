...
type NatGatewayPublicIPAssociationStatus struct {
	...
	// +optional
	Output *NatGatewayPublicIPAssociationSpec `json:"output,omitempty"`
	// +optional
...
// NatGatewayPublicIPAssociationList is a list of NatGatewayPublicIPAssociations
type NatGatewayPublicIPAssociationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of NatGatewayPublicIPAssociation CRD objects
	Items []NatGatewayPublicIPAssociation `json:"items,omitempty"`
}
