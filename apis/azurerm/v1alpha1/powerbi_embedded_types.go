...
type PowerbiEmbedded struct {
	...
	Spec              PowerbiEmbeddedSpec   `json:"spec,omitempty"`
...
type PowerbiEmbeddedStatus struct {
	...
	// +optional
	Output *PowerbiEmbeddedSpec `json:"output,omitempty"`
	// +optional
...
// PowerbiEmbeddedList is a list of PowerbiEmbeddeds
type PowerbiEmbeddedList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of PowerbiEmbedded CRD objects
	Items []PowerbiEmbedded `json:"items,omitempty"`
}
