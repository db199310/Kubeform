...
type HpcCacheNfsTarget struct {
	...
	Spec              HpcCacheNfsTargetSpec   `json:"spec,omitempty"`
	Status            HpcCacheNfsTargetStatus `json:"status,omitempty"`
}

type HpcCacheNfsTargetSpecNamespaceJunction struct {
...
type HpcCacheNfsTargetSpec struct {
	...
	NamespaceJunction []HpcCacheNfsTargetSpecNamespaceJunction `json:"namespaceJunction" tf:"namespace_junction"`
...
type HpcCacheNfsTargetStatus struct {
	...
	// +optional
	Output *HpcCacheNfsTargetSpec `json:"output,omitempty"`
	// +optional
...
// HpcCacheNfsTargetList is a list of HpcCacheNfsTargets
type HpcCacheNfsTargetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of HpcCacheNfsTarget CRD objects
	Items []HpcCacheNfsTarget `json:"items,omitempty"`
}
