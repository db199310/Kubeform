...
type ExpressRouteGatewayStatus struct {
	...
	// +optional
	Output *ExpressRouteGatewaySpec `json:"output,omitempty"`
	// +optional
...
// ExpressRouteGatewayList is a list of ExpressRouteGateways
type ExpressRouteGatewayList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of ExpressRouteGateway CRD objects
	Items []ExpressRouteGateway `json:"items,omitempty"`
}
