...
type VirtualHubConnectionStatus struct {
	...
	// +optional
	Output *VirtualHubConnectionSpec `json:"output,omitempty"`
	// +optional
...
// VirtualHubConnectionList is a list of VirtualHubConnections
type VirtualHubConnectionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of VirtualHubConnection CRD objects
	Items []VirtualHubConnection `json:"items,omitempty"`
}
