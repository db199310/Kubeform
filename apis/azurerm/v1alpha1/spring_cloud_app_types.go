...
type SpringCloudApp struct {
	...
	Spec              SpringCloudAppSpec   `json:"spec,omitempty"`
...
type SpringCloudAppStatus struct {
	...
	// +optional
	Output *SpringCloudAppSpec `json:"output,omitempty"`
	// +optional
...
// SpringCloudAppList is a list of SpringCloudApps
type SpringCloudAppList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of SpringCloudApp CRD objects
	Items []SpringCloudApp `json:"items,omitempty"`
}
