...
type LogAnalyticsDatasourceWindowsEvent struct {
	...
	Spec              LogAnalyticsDatasourceWindowsEventSpec   `json:"spec,omitempty"`
...
type LogAnalyticsDatasourceWindowsEventStatus struct {
	...
	// +optional
	Output *LogAnalyticsDatasourceWindowsEventSpec `json:"output,omitempty"`
	// +optional
...
// LogAnalyticsDatasourceWindowsEventList is a list of LogAnalyticsDatasourceWindowsEvents
type LogAnalyticsDatasourceWindowsEventList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of LogAnalyticsDatasourceWindowsEvent CRD objects
	Items []LogAnalyticsDatasourceWindowsEvent `json:"items,omitempty"`
}
