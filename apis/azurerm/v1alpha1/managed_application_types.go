...
type ManagedApplicationSpecPlan struct {
...
type ManagedApplicationSpec struct {
	...
	Plan              []ManagedApplicationSpecPlan `json:"plan,omitempty" tf:"plan,omitempty"`
...
type ManagedApplicationStatus struct {
	...
	// +optional
	Output *ManagedApplicationSpec `json:"output,omitempty"`
	// +optional
...
// ManagedApplicationList is a list of ManagedApplications
type ManagedApplicationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of ManagedApplication CRD objects
	Items []ManagedApplication `json:"items,omitempty"`
}
