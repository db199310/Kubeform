...
type HpcCacheBlobTarget struct {
	...
	Spec              HpcCacheBlobTargetSpec   `json:"spec,omitempty"`
...
type HpcCacheBlobTargetStatus struct {
	...
	// +optional
	Output *HpcCacheBlobTargetSpec `json:"output,omitempty"`
	// +optional
...
// HpcCacheBlobTargetList is a list of HpcCacheBlobTargets
type HpcCacheBlobTargetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of HpcCacheBlobTarget CRD objects
	Items []HpcCacheBlobTarget `json:"items,omitempty"`
}
