...
type PolicyRemediation struct {
	...
	Spec              PolicyRemediationSpec   `json:"spec,omitempty"`
...
type PolicyRemediationStatus struct {
	...
	// +optional
	Output *PolicyRemediationSpec `json:"output,omitempty"`
	// +optional
...
// PolicyRemediationList is a list of PolicyRemediations
type PolicyRemediationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of PolicyRemediation CRD objects
	Items []PolicyRemediation `json:"items,omitempty"`
}
