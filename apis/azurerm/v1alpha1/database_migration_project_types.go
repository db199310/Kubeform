...
type DatabaseMigrationProject struct {
	...
	Spec              DatabaseMigrationProjectSpec   `json:"spec,omitempty"`
...
type DatabaseMigrationProjectStatus struct {
	...
	// +optional
	Output *DatabaseMigrationProjectSpec `json:"output,omitempty"`
	// +optional
...
// DatabaseMigrationProjectList is a list of DatabaseMigrationProjects
type DatabaseMigrationProjectList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of DatabaseMigrationProject CRD objects
	Items []DatabaseMigrationProject `json:"items,omitempty"`
}
