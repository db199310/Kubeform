...
type NetworkInterfaceSecurityGroupAssociationStatus struct {
	...
	// +optional
	Output *NetworkInterfaceSecurityGroupAssociationSpec `json:"output,omitempty"`
	// +optional
...
// NetworkInterfaceSecurityGroupAssociationList is a list of NetworkInterfaceSecurityGroupAssociations
type NetworkInterfaceSecurityGroupAssociationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of NetworkInterfaceSecurityGroupAssociation CRD objects
	Items []NetworkInterfaceSecurityGroupAssociation `json:"items,omitempty"`
}
