...
type WindowsVirtualMachineScaleSet struct {
	...
	Spec              WindowsVirtualMachineScaleSetSpec   `json:"spec,omitempty"`
	Status            WindowsVirtualMachineScaleSetStatus `json:"status,omitempty"`
}

type WindowsVirtualMachineScaleSetSpecAdditionalCapabilities struct {
	// +optional
	UltraSsdEnabled bool `json:"ultraSsdEnabled,omitempty" tf:"ultra_ssd_enabled,omitempty"`
}

type WindowsVirtualMachineScaleSetSpecAdditionalUnattendContent struct {
	Content string `json:"-" sensitive:"true" tf:"content"`
	Setting string `json:"setting" tf:"setting"`
}

type WindowsVirtualMachineScaleSetSpecAutomaticInstanceRepair struct {
	Enabled bool `json:"enabled" tf:"enabled"`
	// +optional
	GracePeriod string `json:"gracePeriod,omitempty" tf:"grace_period,omitempty"`
}

type WindowsVirtualMachineScaleSetSpecAutomaticOsUpgradePolicy struct {
...
type WindowsVirtualMachineScaleSetSpecBootDiagnostics struct {
	StorageAccountURI string `json:"storageAccountURI" tf:"storage_account_uri"`
}

type WindowsVirtualMachineScaleSetSpecDataDisk struct {
...
type WindowsVirtualMachineScaleSetSpecIdentity struct {
	// +optional
...
type WindowsVirtualMachineScaleSetSpecNetworkInterfaceIpConfigurationPublicIPAddressIpTag struct {
	Tag  string `json:"tag" tf:"tag"`
	Type string `json:"type" tf:"type"`
}

type WindowsVirtualMachineScaleSetSpecNetworkInterfaceIpConfigurationPublicIPAddress struct {
	// +optional
	...
	// +optional
	IpTag []WindowsVirtualMachineScaleSetSpecNetworkInterfaceIpConfigurationPublicIPAddressIpTag `json:"ipTag,omitempty" tf:"ip_tag,omitempty"`
	Name  string                                                                                 `json:"name" tf:"name"`
	// +optional
	PublicIPPrefixID string `json:"publicIPPrefixID,omitempty" tf:"public_ip_prefix_id,omitempty"`
}

type WindowsVirtualMachineScaleSetSpecNetworkInterfaceIpConfiguration struct {
	// +optional
	...
	// +optional
	PublicIPAddress []WindowsVirtualMachineScaleSetSpecNetworkInterfaceIpConfigurationPublicIPAddress `json:"publicIPAddress,omitempty" tf:"public_ip_address,omitempty"`
	// +optional
...
type WindowsVirtualMachineScaleSetSpecNetworkInterface struct {
	// +optional
	...
	IpConfiguration    []WindowsVirtualMachineScaleSetSpecNetworkInterfaceIpConfiguration `json:"ipConfiguration" tf:"ip_configuration"`
	Name               string                                                             `json:"name" tf:"name"`
	// +optional
...
type WindowsVirtualMachineScaleSetSpecOsDiskDiffDiskSettings struct {
	Option string `json:"option" tf:"option"`
}

type WindowsVirtualMachineScaleSetSpecOsDisk struct {
	Caching string `json:"caching" tf:"caching"`
	// +optional
	// +kubebuilder:validation:MaxItems=1
	DiffDiskSettings []WindowsVirtualMachineScaleSetSpecOsDiskDiffDiskSettings `json:"diffDiskSettings,omitempty" tf:"diff_disk_settings,omitempty"`
	// +optional
	DiskEncryptionSetID string `json:"diskEncryptionSetID,omitempty" tf:"disk_encryption_set_id,omitempty"`
	// +optional
...
type WindowsVirtualMachineScaleSetSpecPlan struct {
	Name      string `json:"name" tf:"name"`
	Product   string `json:"product" tf:"product"`
	Publisher string `json:"publisher" tf:"publisher"`
}

type WindowsVirtualMachineScaleSetSpecRollingUpgradePolicy struct {
...
type WindowsVirtualMachineScaleSetSpecSecretCertificate struct {
	Store string `json:"store" tf:"store"`
	Url   string `json:"url" tf:"url"`
}

type WindowsVirtualMachineScaleSetSpecSecret struct {
	// +kubebuilder:validation:MinItems=1
	Certificate []WindowsVirtualMachineScaleSetSpecSecretCertificate `json:"certificate" tf:"certificate"`
	KeyVaultID  string                                               `json:"keyVaultID" tf:"key_vault_id"`
}

type WindowsVirtualMachineScaleSetSpecSourceImageReference struct {
...
type WindowsVirtualMachineScaleSetSpecTerminateNotification struct {
	Enabled bool `json:"enabled" tf:"enabled"`
	// +optional
	Timeout string `json:"timeout,omitempty" tf:"timeout,omitempty"`
}

type WindowsVirtualMachineScaleSetSpecWinrmListener struct {
	// +optional
...
type WindowsVirtualMachineScaleSetSpec struct {
	...
	// +optional
	// +kubebuilder:validation:MaxItems=1
	AdditionalCapabilities []WindowsVirtualMachineScaleSetSpecAdditionalCapabilities `json:"additionalCapabilities,omitempty" tf:"additional_capabilities,omitempty"`
	// +optional
	AdditionalUnattendContent []WindowsVirtualMachineScaleSetSpecAdditionalUnattendContent `json:"additionalUnattendContent,omitempty" tf:"additional_unattend_content,omitempty"`
	AdminPassword             string                                                       `json:"-" sensitive:"true" tf:"admin_password"`
	AdminUsername             string                                                       `json:"adminUsername" tf:"admin_username"`
	// +optional
	// +kubebuilder:validation:MaxItems=1
	AutomaticInstanceRepair []WindowsVirtualMachineScaleSetSpecAutomaticInstanceRepair `json:"automaticInstanceRepair,omitempty" tf:"automatic_instance_repair,omitempty"`
	// +optional
	// +kubebuilder:validation:MaxItems=1
	AutomaticOsUpgradePolicy []WindowsVirtualMachineScaleSetSpecAutomaticOsUpgradePolicy `json:"automaticOsUpgradePolicy,omitempty" tf:"automatic_os_upgrade_policy,omitempty"`
	// +optional
	// +kubebuilder:validation:MaxItems=1
	BootDiagnostics []WindowsVirtualMachineScaleSetSpecBootDiagnostics `json:"bootDiagnostics,omitempty" tf:"boot_diagnostics,omitempty"`
	// +optional
	...
	// +optional
	DataDisk []WindowsVirtualMachineScaleSetSpecDataDisk `json:"dataDisk,omitempty" tf:"data_disk,omitempty"`
	// +optional
	...
	// +optional
	// +kubebuilder:validation:MaxItems=1
	Identity  []WindowsVirtualMachineScaleSetSpecIdentity `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	Name             string                                              `json:"name" tf:"name"`
	NetworkInterface []WindowsVirtualMachineScaleSetSpecNetworkInterface `json:"networkInterface" tf:"network_interface"`
	// +kubebuilder:validation:MaxItems=1
	OsDisk []WindowsVirtualMachineScaleSetSpecOsDisk `json:"osDisk" tf:"os_disk"`
	// +optional
	Overprovision bool `json:"overprovision,omitempty" tf:"overprovision,omitempty"`
	// +optional
	// +kubebuilder:validation:MaxItems=1
	Plan []WindowsVirtualMachineScaleSetSpecPlan `json:"plan,omitempty" tf:"plan,omitempty"`
	// +optional
	...
	// +optional
	// +kubebuilder:validation:MaxItems=1
	RollingUpgradePolicy []WindowsVirtualMachineScaleSetSpecRollingUpgradePolicy `json:"rollingUpgradePolicy,omitempty" tf:"rolling_upgrade_policy,omitempty"`
	// +optional
	ScaleInPolicy string `json:"scaleInPolicy,omitempty" tf:"scale_in_policy,omitempty"`
	// +optional
	Secret []WindowsVirtualMachineScaleSetSpecSecret `json:"secret,omitempty" tf:"secret,omitempty"`
	// +optional
	...
	// +optional
	// +kubebuilder:validation:MaxItems=1
	SourceImageReference []WindowsVirtualMachineScaleSetSpecSourceImageReference `json:"sourceImageReference,omitempty" tf:"source_image_reference,omitempty"`
	// +optional
	Tags map[string]string `json:"tags,omitempty" tf:"tags,omitempty"`
	// +optional
	// +kubebuilder:validation:MaxItems=1
	TerminateNotification []WindowsVirtualMachineScaleSetSpecTerminateNotification `json:"terminateNotification,omitempty" tf:"terminate_notification,omitempty"`
	// +optional
	...
	// +optional
	WinrmListener []WindowsVirtualMachineScaleSetSpecWinrmListener `json:"winrmListener,omitempty" tf:"winrm_listener,omitempty"`
	// +optional
...
type WindowsVirtualMachineScaleSetStatus struct {
	...
	// +optional
	Output *WindowsVirtualMachineScaleSetSpec `json:"output,omitempty"`
	// +optional
...
// WindowsVirtualMachineScaleSetList is a list of WindowsVirtualMachineScaleSets
type WindowsVirtualMachineScaleSetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of WindowsVirtualMachineScaleSet CRD objects
	Items []WindowsVirtualMachineScaleSet `json:"items,omitempty"`
}
