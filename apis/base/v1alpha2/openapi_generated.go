...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/kubeform/apis/base/v1alpha2.State":                 schema_kubeform_apis_base_v1alpha2_State(ref),
	}
}
...
func schema_kubeform_apis_base_v1alpha2_State(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
